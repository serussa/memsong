...
"""Evaluate only the two new late-only methods."""
...
METHODS = ["late_only_lam005", "tsm_late_only_lam003"]
...
for method in METHODS:
    ...
    for lang, lang_code in [("zh", "zh"), ("en", "en")]:
        ...
        run_cmd([PYTHON, str(PIPELINE_DIR / "eval_songeval.py"),
            ...
            "--ckpt", str(SONGEVAL_CKPT), "--config", str(SONGEVAL_CONFIG),
            "--gpu", "0"], f"SongEval [{model_name}]")
